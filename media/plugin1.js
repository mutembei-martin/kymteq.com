(function ( $ ) {
    ...
    var methods = {
        init : function(options) {
            ...
            // Create percentage
            var percentage = $("<div class='progress-percentage1'></div>");
            ...
            // Create text
            var text = $("<div class='progress-text1'></div>");
    ...
    $.fn.circularProgressy = function(methodOrOptions) {
